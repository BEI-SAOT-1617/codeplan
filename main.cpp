...
// Test of the versions

	myPlanManager.generatePlan("plan1_1.txt");
	myPlanManager.generatePlan("plan1_2.txt");
	myPlanManager.generatePlan("plan1_3.txt");

// Test of the rotating buffer
	
	myPlanManager.generatePlan("plan2_1.txt");
	myPlanManager.generatePlan("plan3_1.txt");
	myPlanManager.generatePlan("plan4_1.txt");


	myPlanManager.printPlan(0);
	myPlanManager.printPlan(1);

	/*while(1){
	myPlanManager.executePlan();
	}*/
}
